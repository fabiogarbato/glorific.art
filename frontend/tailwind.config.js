    ...
    theme: {
        extend: {
            colors: {
                ...brand,
                brand,
                // Superficies/texto que o admin re-tema via CSS var (ver
                // [data-scheme="admin"] em styles/index.css). No storefront
                // resolvem pros mesmos tons de sempre — zero mudanca visual la.
            ...
            animation: {
                ...
                "pulse-suave": "pulse-suave 3.5s ease-in-out infinite",
            },
        },
    },
    plugins: [daisyui],
